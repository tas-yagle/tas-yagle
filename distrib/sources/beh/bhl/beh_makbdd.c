...
static pNode beh_abl2bdd(befig_list *pt_befig, chain_list *expr)

  {
  short         oper        ;
  struct node  *pt_bdd      = BDD_zero;
...
static void beh_mbddtot(befig_list *pt_befig)
...
void beh_makbdd (befig_list *pt_befig)
