...
#define yylval vhd_bcomplval
#define YY_NO_UNPUT

#include "bvl_byacc.h"
#include "vhd_bcomp.tab.h"
#include "bvl_blex.h"
...
char  *key;
  ...
  if (pt_hash == NULL)
    ...
    addhtitem (pt_hash, namealloc("event")        , EVENT        );
    ...
    addhtitem (pt_hash, namealloc("std_logic")    , STD_LOGIC    );
    addhtitem (pt_hash, namealloc("std_logic_vector")    , STD_LOGIC_VECTOR );
