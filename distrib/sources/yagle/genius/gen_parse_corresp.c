          ...
          if (__crt==NULL)
            {
              ...
              //avt_fprintf(stderr,"[" AVT_RED "" AVT_BOLD "Error" AVT_RESET "] While parsing correspondance tables, line %d, transistor out of context\n",msl_line);
              ret=1;
            }
          else
            {
              ...
              if ((l=gethtitem(ALL_TRS, c))==EMPTYHT)
                {
                  ...
                  //avt_fprintf(stderr,"[" AVT_RED "" AVT_BOLD "Error" AVT_RESET "] While parsing correspondance tables, line %d, could not find transistor '%s' in original netlist\n",msl_line, tab[4]);
                  ret=1;
                }
              else
                {
          ...
          if (__crt==NULL)
            {
              ...
              //avt_fprintf(stderr,"[" AVT_RED "" AVT_BOLD "Error" AVT_RESET "] While parsing correspondance tables, line %d, signal out of context\n",msl_line);
              ret=1;
            }
          else
            {
...
//                  avt_fprintf(stderr,"[" AVT_RED "" AVT_BOLD "Error" AVT_RESET "] While parsing correspondance tables, line %d, could not find signal '%s' in original netlist\n",msl_line, tab[4]);
                  ret=1;
                }
              else
                {
          ...
          if (__crt==NULL)
            {
              ...
              avt_fprintf(stderr,"[" AVT_RED "" AVT_BOLD "Error" AVT_RESET "] While parsing correspondance tables, line %d, instance out of context\n",msl_line);
              ret=1;
            }
          else
            {
              ...
              if ((l=gethtitem(ALL_CRT, c))==EMPTYHT)
                {
                  ...
                  //avt_fprintf(stderr,"[" AVT_RED "" AVT_BOLD "Error" AVT_RESET "] While parsing correspondance tables, line %d, could not find instance correspondance '%s' table\n",msl_line, tab[4]);
                  ret=1;
                }
              else
                {
          ...
          if ((l=gethtitem(ALL_CRT, c))==EMPTYHT)
            {
              ...
              //avt_fprintf(stderr,"[" AVT_RED "" AVT_BOLD "Error" AVT_RESET "] While parsing correspondance tables, line %d, could not find instance correspondance table\n",msl_line);
              ret=1;
            }
          else
            {
          ...
          if (__crt==NULL)
            {
              ...
              //avt_fprintf(stderr,"[" AVT_RED "" AVT_BOLD "Error" AVT_RESET "] While parsing correspondance tables, line %d, variables out of context\n",msl_line);
              ret=1;
            }
          else
            {
          ...
          if (dicotab==NULL)
            {
              ...
              //avt_fprintf(stderr,"[" AVT_RED "" AVT_BOLD "Error" AVT_RESET "] While parsing correspondance tables, line %d, dictionary entry without dictionary mode\n",msl_line);
              EXIT(1);
            }
          for (i=3;i<cnt;i++)
            {
...
//                  avt_fprintf(stderr,"[" AVT_RED "" AVT_BOLD "Error" AVT_RESET "] While parsing correspondance tables, line %d, too many entries in dictionary\n",msl_line);
                  EXIT(1);
                }
...
//            avt_fprintf(stderr,"[" AVT_YELLOW "" AVT_BOLD "Warning" AVT_RESET "] While parsing correspondance tables, line %d ignored\n",msl_line);
          }
    }
