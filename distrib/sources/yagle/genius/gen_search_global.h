...
/****************************************************************************/
/*           Return a list of instances extracted from netlist              */
/* models to extract are given by parameters genius and fcl                 */
/* do action associated with the model if recognized in netlist             */
/****************************************************************************/
extern chain_list *FindInstances(lofig_list *netlist, chain_list *genius_models, chain_list *fcl_models);
