...
class Language 
{
 public:
  ...
  virtual void create_man (const char *, ApiType *, ParmList *, functionman *);
  virtual void create_xml (const char *, const char *, ApiType *, ParmList *, functionman *, int, int);
  virtual void create_db (const char *, const char *, ApiType *, ParmList *, functionman *, int, int);
  ...
  virtual void set_module (const char *);
